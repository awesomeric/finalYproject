/**
 * Created by EricTang on 16/4/8.
 */
(function($) {
    $.fn.jquizzy = function(settings) {
        var defaults = {
            questions: null,
            startImg: 'images/icon.png',
            endText: '已结束!',
            shortURL: null,
            sendResultsURL: null,
            resultComments: {
        ...
        var superContainer = $(this),
            ...
            introFob = '	<div class="intro-container slide-container">' +
                '<a class="nav-start" href="#">请认真完成测试题。准备好了吗？<br/><br/><span><img src="'+config.startImg+'"></span>' + '</a>' + '</div>	',
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            for (answersIteratorIndex = 0; answersIteratorIndex < config.questions[questionsIteratorIndex].answers.length; answersIteratorIndex++) {
                contentFob += '<li class=" button-glow button-large button-rounded button-3d button-border">' + config.questions[questionsIteratorIndex].answers[answersIteratorIndex] + '</li>';
            }
            contentFob += '</ul><div class="nav-container">';
            if (questionsIteratorIndex !== 0) {
                contentFob += '<div class="prev"><a class="button button-3d button-primary button-rounded" href="#">pre</a></div>';
            }
            if (questionsIteratorIndex < config.questions.length - 1) {
                contentFob += '<div class="next"><a class="button button-3d button-highlight button-rounded" href="#">next</a></div>';
            } else {
                contentFob += '<div class="next final"><a class="button button-3d button-caution button-rounded" href="nav-show-result">done</a></div>';
            }
            contentFob += '</div></div>';
        ...
        var progress = superContainer.find('.progress'),
            ...
            progressKeeper1 =progressWidth = progressKeeper.width(),
            progressKeeper1 =superContainer.find('#progressbar'),
